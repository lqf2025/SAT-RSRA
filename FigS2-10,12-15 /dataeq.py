...
def print_full_summary(list_k):
    ...
    # Table Header
    # Algo(12) | k(6) | b(10) | CI_lo(10) | CI_hi(10) | R2(8)
    ...
    for k in list_k:
        # 1) VQE-RSRA
        try:
            path = f"classical-FigS2-S10a/unirecovereq/Classical_keq{k}.npz"
            ...
            lo_inv = 1.0 / b_ci_p[1]
            hi_inv = 1.0 / b_ci_p[0]
            print(r_fmt.format("VQE-RSRA", str(k), b_inv, lo_inv, hi_inv, r2))
        except: pass

        # 2) QAA (Layer 150)
        try:
            path = f"QAA-FigS2-S10b/QAArecovereq/recoverQAAeq{k}.npz"
            d = np.load(path, allow_pickle=True)
...
# ==============================================================================
# Part 2: Detailed Classical Breakdown (Consolidated Table)
# ==============================================================================
...
def print_detailed_classical_breakdown(list_k, digits=4):
    ...
    for k in list_k:
        npz_file = f"classical-FigS2-S10a/unirecovereq/Classical_keq{k}.npz"
