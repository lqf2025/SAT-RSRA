...
for n in range(start,final):
    data0=np.load("exp"+str(n)+" "+str(0)+".npz")
    data1=np.load("exp"+str(n)+" "+str(1)+".npz")
    data2=np.load("exp"+str(n)+" "+str(2)+".npz")
    data3=np.load("exp"+str(n)+" "+str(3)+".npz")
    data4=np.load("exp"+str(n)+" "+str(4)+".npz")
    data5=np.load("exp"+str(n)+" "+str(5)+".npz")
    data6=np.load("exp"+str(n)+" "+str(6)+".npz")
    data7=np.load("exp"+str(n)+" "+str(7)+".npz")
    data8=np.load("exp"+str(n)+" "+str(8)+".npz")
    data9=np.load("exp"+str(n)+" "+str(9)+".npz")
...
plt.xticks(np.arange(5,final,4))
